...
HD_PWD='D:/Xilinx/ECE_524L/Final Project/PMOD CLS/PMOD CLS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodCLS_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodCLS_Demo.tcl -notrace
