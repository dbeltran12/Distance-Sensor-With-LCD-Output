...
HD_PWD='D:/Xilinx/ECE_524L/Final Project/PMOD CLS/PMOD CLS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodCLS_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodCLS_Demo.tcl
